  ...
  return (
      <div className="md:w-1/2 lg:w-2/5 mx-5"> 
        ...
        <div className="mb-5">
          ...
          <div className="mb-5">
            <label htmlFor="propietario" className="block text-grey-700 uppercase">Nombre Propietario</label>
            <input 
              id="propietario"
              type="text"
          ...
          <div className="mb-5">
            <label htmlFor="sintomas" className="block text-grey-700 uppercase">Sintomas</label>
            <textarea 
              id="sintomas"
